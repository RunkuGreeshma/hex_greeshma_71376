...
abstract class Employee
{
	...
	public static  void display()
	{
		try
		{
			...
			Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/employees","System","Charan");
	...
	public static  void riseSalary()
	{
		...
		{
			Class.forName("com.mysql.jdbc.Driver"); // mysql 
			Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/employees","System","Jagruti");
